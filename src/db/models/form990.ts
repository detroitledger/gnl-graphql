...
export type Form990Instance = Sequelize.Instance<Form990Attributes> & Form990Attributes;

export default (sequelize: Sequelize.Sequelize) => sequelize.define<Form990Instance, Form990Attributes>('Form990', {
